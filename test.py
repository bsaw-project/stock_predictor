...
def load_data():
    ...
    #     )
    # )
    client = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\Client.csv')
    pfolio = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\Portfolio.csv')
    data = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\data.csv')

    reco = pd.read_csv('D:/Programming/BSAW/bsaw-project/data/reco_output.csv')                    # CHANGE THIS
    
    pred_data = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\pred_data.csv')                 # CHANGE THIS

    stock = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\stock_data.csv')[1:]                # CHANGE THIS

    sentiment_output = pd.read_csv('D:\Programming\BSAW/bsaw-project\data\sentiment_output.csv')    # CHANGE THIS

    final_data = pd.read_csv('D:\Programming\BSAW/bsaw-project\data/final_data.csv')                # CHANGE THIS
    ...
    if risk in customer_data['volatile'].unique():
        ...
        def real_time(): 
            ...
            for i,ticker in enumerate(newDF['Ticker']):
                ...
                col.metric(label=a, value = f'$ {round(close_today1, 2)}', delta = f'{round(((close_today1-close_today2)/close_today2)*100, 2)} %')
            st.markdown("""---""")
        ##############################################################################################
        real_time()
